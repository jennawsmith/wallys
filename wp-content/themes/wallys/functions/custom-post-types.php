...
function create_post_type_html5()
{
    ...
    */
    ...
    register_post_type('our_work', // Register Custom Post Type
        array(
        'labels' => array(
            'name' => __('Our_Work', 'html5blank'), // Rename these to suit
            'singular_name' => __('our_work', 'html5blank'),
            'add_new' => __('Add New', 'html5blank'),
            'add_new_item' => __('Add New Work', 'html5blank'),
            'edit' => __('Edit', 'html5blank'),
            'edit_item' => __('Edit Our Work', 'html5blank'),
            'new_item' => __('New Work', 'html5blank'),
            'view' => __('View Our Work', 'html5blank'),
            'view_item' => __('View Work', 'html5blank'),
            'search_items' => __('Search Our Work', 'html5blank'),
            'not_found' => __('No Work', 'html5blank'),
    ...
    register_taxonomy(
        'type_of_work',    // Taxonomy
        'our_work',         // Object Type
        array(
            'label' => __( 'Type' ),
            'rewrite' => array( 'slug' => 'type' ),
            'hierarchical' => true, // Is this taxonomy hierarchical like categories or not hierarchical like tags.
