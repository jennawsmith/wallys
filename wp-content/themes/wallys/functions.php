...
{
    wp_register_style('wallys-styles', get_template_directory_uri() . '/css/main.css', array(), '1.0', 'all');
    wp_enqueue_style('wallys-styles'); // Enqueue it!
}
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        ...
        'description' => __('Widgets', 'html5blank'),
        'id' => 'widget-area-1',
